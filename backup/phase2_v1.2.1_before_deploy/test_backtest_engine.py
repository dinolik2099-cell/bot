...
def test_gap_is_counted_and_blocks_strategy_call():
    df = make_frame([
        {"open": 100, "high": 101, "low": 99, "close": 100},
        {"open": 101, "high": 102, "low": 100, "close": 101},
        {"open": 102, "high": 103, "low": 101, "close": 102},
...
def test_gap_does_not_create_synthetic_bar():
    df = make_frame([
        {"open": 100, "high": 101, "low": 99, "close": 100},
        {"open": 101, "high": 102, "low": 100, "close": 101},
        {"open": 103, "high": 104, "low": 102, "close": 103},
...
def main():
    ...
    test_gap_is_counted_and_blocks_strategy_call()
    test_gap_does_not_create_synthetic_bar()
    print("BACKTEST_ENGINE_V1_2_TEST_OK")
