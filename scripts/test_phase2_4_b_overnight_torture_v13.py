...
files=['scripts/run_phase2_4_b_overnight_torture_v13.py','scripts/run_phase2_4_b_shared_capital_backtest.py']
for f in files: ast.parse((ROOT/f).read_text(encoding='utf-8'))
code=(ROOT/'scripts/run_phase2_4_b_overnight_torture_v13.py').read_text(encoding='utf-8')
...
print('PHASE2_4_B_OVERNIGHT_TORTURE_V13_TEST_OK')
