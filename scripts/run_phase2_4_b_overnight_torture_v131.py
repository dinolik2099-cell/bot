...
def main():
    ...
    out=ROOT/'data/reports/phase2_4_b_overnight_torture_v131.jsonl'; out.parent.mkdir(parents=True,exist_ok=True)
    summary=ROOT/'data/reports/phase2_4_b_overnight_torture_summary_v131.md'
