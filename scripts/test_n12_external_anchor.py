...
def main():
 ...
 manifest=seal({'schema_version':'quantbot-non-oos-series-n12-v1','input_n11_artifact_identity':n11,'candidate_count':2,'series_count':4,'rows':rows,'oos_status':'SEALED','oos_authorization':'NOT_AUTHORIZED'})
