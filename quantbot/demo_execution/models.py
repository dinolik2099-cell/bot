...
class OrderState(str,Enum):
 DISCOVERED='DISCOVERED';VALIDATED='VALIDATED';INTENT_CREATED='INTENT_CREATED';SUBMITTING='SUBMITTING';SUBMITTED='SUBMITTED';ACKNOWLEDGED='ACKNOWLEDGED';PARTIALLY_FILLED='PARTIALLY_FILLED';FILLED='FILLED';CANCELED='CANCELED';EXPIRED='EXPIRED';REJECTED='REJECTED';FAILED_SAFE='FAILED_SAFE';RECONCILING='RECONCILING';SKIPPED='SKIPPED'

TERMINAL={OrderState.FILLED,OrderState.CANCELED,OrderState.EXPIRED,OrderState.REJECTED,OrderState.FAILED_SAFE,OrderState.SKIPPED}
