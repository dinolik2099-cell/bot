...
class ExecutionLedger:
 ...
 def unresolved(self):return [dict(row) for row in self.rows.values() if row['state'] not in {OrderState.FILLED.value,OrderState.CANCELED.value,OrderState.REJECTED.value,OrderState.FAILED_SAFE.value}]
